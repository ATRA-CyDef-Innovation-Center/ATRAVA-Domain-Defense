...
- [ ] Verify containers running:
  ...
  - [ ] gcot-prometheus (running)
  - [ ] gcot-grafana (running)
...
- [ ] Test DNS resolution:
  ...
  ```
- [ ] Check Prometheus metrics: `curl http://localhost:9153/metrics`
...
- [ ] Verify CoreDNS targets are scraped:
  - [ ] Click Status → Targets
  - [ ] Should see gcot-dns-node endpoint
  - [ ] Status should be "UP"
...
- [ ] Import CoreDNS dashboard:
  - [ ] Dashboard ID: 13396 (official CoreDNS)
...
### Performance
- [ ] Monitor query latency in Prometheus
