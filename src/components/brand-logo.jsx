...
export function BrandMark({ className }) {
    ...
    const glowId = useId();
    return (<svg viewBox="0 0 64 64" aria-hidden="true" className={cn('h-10 w-10', className)} xmlns="http://www.w3.org/2000/svg">
      <defs>
      ...
      <path d="M32 10L47 15.4V29C47 39.3 40.9 48 32 52C23.1 48 17 39.3 17 29V15.4L32 10Z" fill={`url(#${shieldId})`}/>
      <path d="M32 14.5L43 18.5V28.6C43 36.3 38.6 43 32 46.7C25.4 43 21 36.3 21 28.6V18.5L32 14.5Z" fill="#081121"/>
...
export function BrandLogo({ className, markClassName, textClassName, subtitleClassName, compact = false, }) {
    return (<div className={cn('flex items-center gap-3', className)}>
      ...
      <div className="min-w-0 leading-none">
        ...
        {!compact && (<div className={cn('mt-1 truncate text-[0.65rem] font-semibold uppercase tracking-[0.42em] text-sky-400/90', subtitleClassName)}>
            Domain Defense
          </div>)}
      </div>
    </div>);
