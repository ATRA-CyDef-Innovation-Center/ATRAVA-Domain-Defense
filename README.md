...
Blacklist entries are normalized as hostnames. A parent-domain entry such as `youtube.com` is enforced for both `youtube.com` and matching subdomains such as `www.youtube.com` through the generated CoreDNS template policy file.
