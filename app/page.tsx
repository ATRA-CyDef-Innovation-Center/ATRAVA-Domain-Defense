      ...
      <div className="min-h-screen bg-background">
        ...
        <main className="ml-64 p-8">
          ...
          <div className="mb-8">
            ...
            {userProfile && (
              <p className="text-sm text-primary mt-2">Signed in as {ROLE_LABELS[userProfile.role]}</p>
            )}
          </div>
            ...
            <CardContent>
              <div className="space-y-4">
                {recentBlocks.map((block, idx) => (
                  <div key={idx} className="flex items-center justify-between p-4 bg-secondary rounded-lg border border-border">
